...
export const KULINER_FIXTURE: SiteContent = {
  info: {
    name: "Warung Bu Sari",
      ...
      items: [
        {
          ...
          image_key: "t/warung-bu-sari/menu/ayam-bakar.webp",
          images: ["t/warung-bu-sari/menu/ayam-bakar-2.webp"],
          featured: true,
          special: true,
        },
        { name: "Menu Rahasia Lama", price: 99000, active: false },
        { name: "Nasi Rendang", price: 22000, featured: true },
        { name: "Ayam Goreng Lengkuas", price: 17000, featured: true },
  ...
  gallery: [
    ...
    { image_key: "t/warung-bu-sari/gallery/02.webp", alt: "Dapur bersih" },
  ],
};
